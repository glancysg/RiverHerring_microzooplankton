...
# CMH- no new column, relate day age to microzoo dates. create loops 
# for each fish- if there's one with age 4 that matches, use that one, 
# if not, use fish age of 4 or 5 (maybe function near() )
